...
Security audit your projects directly inside Claude Code. 25 agents, 80+ attack classes, zero setup.

## Install

```bash
claude plugin add github:/praxis
```
...
| Command | Description |
|---------|-------------|
| `/praxis` | Full security audit — 25 agents, 80+ attack classes, prioritized remediation plan |
...
> /praxis
Runs full audit with all 25 security agents, shows score, findings grouped
