...
description: Run a multi-agent red team scan — 25 specialized security agents scan for 80+ attack classes including injection, auth bypass, SSRF, supply chain, Supabase RLS, MCP security, agentic AI, RAG poisoning, PII compliance, model-file risk, prompt injection, and more. Use when the user wants a deep security analysis beyond just secrets.
argument-hint: "[path] [--agents <list>]"
---

# Praxis — Red Team Scan

You are running a multi-agent red team scan using Praxis's 25 security agents.
