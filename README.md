...
Praxis is an enterprise-grade Static Application Security Testing (SAST) and AI-safety auditing framework designed to detect vulnerabilities and automate patch engineering. Operating as a command-line interface (CLI), Praxis analyzes application codebases, Model Context Protocol (MCP) server configurations, and AI agent integration points to identify traditional vulnerabilities and modern generative AI exposure risks. 
