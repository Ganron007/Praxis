...
export const controls = [
  ...
  { id: 'Art.26',  title: 'Obligations of deployers',                 description: 'Deployers must use high-risk systems per instructions, ensure input relevance, and monitor operation (Art. 26).' },
  { id: 'Art.27',  title: 'Fundamental rights impact assessment',     description: 'Deployers of high-risk systems assess impact on fundamental rights before deployment (Art. 27).' },
  { id: 'Art.49',  title: 'Registration',                             description: 'High-risk systems registered in the EU database before market placement (Art. 49).' },
