 ...
 *
 * USAGE:
 *   praxis fix             Scan and generate .env.example
 *   praxis fix --dry-run   Preview what would be generated (don't write file)
 */
 ...
 * e.g. "OpenAI API Key" → "OPENAI_API_KEY" // praxis-ignore — env var name in doc comment, not a secret value
 */
...
function printEnvExample(envVars, dryRun) {
  const lines = [
    '# .env.example',
    '# Generated by praxis — replace placeholder values with your actual secrets.',
