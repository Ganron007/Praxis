 ...
 *
 * USAGE:
 *   praxis openclaw [path]           Scan agent configs
 *   praxis openclaw . --fix          Auto-harden configurations
 *   praxis openclaw . --preflight    Exit non-zero on critical (for CI)
 *   praxis openclaw . --red-team     Simulate adversarial attacks
 */
...
export async function openclawCommand(targetPath = '.', options = {}) {
  ...
  console.log();
  output.header('Praxis — OpenClaw Security Scan');
  console.log();
