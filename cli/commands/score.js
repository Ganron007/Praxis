...
function printScore(score, grade, ctx) {
  ...
  console.log(chalk.gray('  Share your score & track trends: ') + chalk.cyan(''));
  console.log();
}
 ...
 * and without .praxisignore loading — score is a quick overview).
 */
