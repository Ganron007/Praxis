 ...
 *
 * USAGE:
 *   praxis checklist              Interactive mode (prompts for each item)
 *   praxis checklist --no-interactive   Print checklist without prompts
 *
...
const CHECKLIST_ITEMS = [
  ...
  },
  {
    ...
    fix: 'Use praxis init --headers to add security headers config.'
  },
  {
...
function printSummary(results) {
  ...
  if (todo === 0 && skipped === 0) {
    console.log(chalk.green.bold('  \ud83d\ude80 You\'re ready to launch!'));
  } else if (todo > 0) {
